                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach($rentalps as $rentps)
                            <tr onclick="window.location='/show/{{ $rentps->id }}';">
                                <td class='mode-text' scope='row'>
                                    <a href="/show/{{ $rentps->id }}" class="btn-show">{{ $rentps->id }}</a>
                                </td>
                                <td class='mode-text'>
                                    <a href="/show/{{ $rentps->id }}" class="btn-show">{{ $rentps->brand->merek }}</a>
                                </td>
                                <td class='mode-text'>
                                    <a href="/show/{{ $rentps->id }}" class="btn-show">{{ $rentps->jenis }}</a>
                                </td>
                                <td class='mode-text'>
                                    <a href="/show/{{ $rentps->id }}" class="btn-show">Rp.{{ $rentps->harga }}/day</a>
                                </td>
                                <td class='mode-text'>
                                    <a href="/show/{{ $rentps->id }}" class="btn-show"><b>Rp.{{ $rentps->per_week }}</b>/week</a>
                                </td>
                            </tr>
                        @endforeach
                        <tr class="row-create text-center" onclick="window.location='{{ route('create') }}';">
                            <td colspan="5">
