...
Route::get('/update/{id}', [RentalController::class, 'edit'])->name('edit')->middleware('auth');
Route::put('/{id}', [RentalController::class, 'update'])->name('update')->middleware('auth');

Route::delete('/{id}', [RentalController::class, 'destroy'])->name('delete')->middleware('auth');