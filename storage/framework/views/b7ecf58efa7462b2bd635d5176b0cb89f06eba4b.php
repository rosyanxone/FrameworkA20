    ...
    <header id="home">
        ...
        <nav class="mode-bg">
            ...
            <div class="login-button btn btn-primary">
                <a href="<?php echo e(Auth::user() ? '/logout' : '/login'); ?>" class="nav-link active" aria-current="page">
                    <?php echo e(Auth::user() ? 'Logout' : 'Login'); ?>
        ...
        <div class="price-container mode-bg">
            ...
            <div class="price-table">
                <table class="table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $rentalps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rentps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class='mode-text' scope='row'><?php echo e($rentps->id); ?></td>
                                <td class='mode-text'><?php echo e($rentps->brand->merek); ?></td>
                                <td class='mode-text'><?php echo e($rentps->jenis); ?></td>
                                <td class='mode-text'>Rp.<?php echo e($rentps->harga); ?>/day</td>
                                <td class='mode-text'><b>Rp.<?php echo e($rentps->per_week); ?></b>/week</td>
                            </tr>
...
</html><?php /**PATH D:\Kuliah\Prak Framework\FrameworkA20\Posttest03\resources\views/home.blade.php ENDPATH**/ ?>